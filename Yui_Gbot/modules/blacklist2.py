...
from Yui_Gbot import dispatcher, SUDO_USERS, LOGGER, OWNER_ID
from Yui_Gbot.modules.disable import DisableAbleCommandHandler
from Yui_Gbot.modules.helper_funcs.chat_status import can_delete, is_user_admin, user_not_admin, user_admin, \
...
from Yui_Gbot.modules.sql import users_sql
...
def __stats__():
	return "{}<b>» BLackList Stickers, Across </b>{} Chats.".format(sql.num_stickers_filters(), sql.num_stickers_filter_chats())
