...
from Yui_Gbot import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from Yui_Gbot.modules.helper_funcs.handlers import CMD_STARTERS
from Yui_Gbot.modules.helper_funcs.misc import is_module_loaded, send_to_list
    ...
    if args:
        if args[0] == 'json':
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(document=output, filename="Yui_Gbot_fbanned_users.csv",
