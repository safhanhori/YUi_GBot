...
from Yui_Gbot.modules.helper_funcs.handlers import CMD_STARTERS, CustomCommandHandler
...
if is_module_loaded(FILENAME):
    ...
    from Yui_Gbot.modules.helper_funcs.chat_status import user_admin, is_user_admin, connection_status
    ...
    def __stats__():
        return f"<b>» {sql.num_disabled()} Disabled items, Across </b>{sql.num_chats()}<b> Chats.</b>\n"
